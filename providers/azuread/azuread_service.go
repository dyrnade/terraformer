...
func (az *AzureADService) getClientArgs() (subscriptionID string, resourceGroup string, authorizer autorest.Authorizer) {
...
func (az *AzureADService) AppendSimpleResourceWithDuplicateCheck(id string, resourceName string, resourceType string) {
...
// same id
func (az *AzureADService) DuplicateCheck(id string, resourceName string, resourceType string) (bool, bool) {
...
func (az *AzureADService) appendSimpleAssociation(id string, linkedResourceName string, resourceName *string, resourceType string, attributes map[string]string) {
